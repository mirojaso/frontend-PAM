...
export default class FormRegisterTeam extends Component {
    constructor() {
        super();
        this.state = {
            show: true,
            ...
            errors: {},
            respuestas: {},
            labels:['Responsable', 'Integrante 2']
    ...
    handleValidation() {
        ...
        $.trim(biodiversidad_details);
         ...
         if(!aviso_privacidad || !transferencia_datos){
            formIsValid = false;
            errors["checkpoliticatyc"] = "Aceptar Política de Privacidad y Términos y Condiciones.";
         }
       ...
       if(!aspecto_relevante){
        ...
        if (!nombre) {
          ...
          if (telefono.length != 10) {
            formIsValid = false;
            errors["telefono"] = "Ingrese un número válido";
          }
          ...
          if (celular.length != 10) {
            formIsValid = false;
            errors["celular"] = "Ingrese un número válido";
          }
          ...
          $inputs.each(function() { 
            if($(this).val()===""){ 
                formIsValid = false;
                errors["datos_participantes"] = "Llena todos los campos solicitados.";
                }
           });
    ...
    onSubmit = e => {
        ...
        if(this.handleValidation()){
          ...
          respuestas["respuesta"] = "Por favor llena todos los campos solicitados.";
          this.setState({ respuestas: respuestas });
    ...
    render() {
        if(this.state.show){
        if (this.state.tipo_participacion==='equipo') {
        return (
          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <p className="vw-text-parrafo" >¡Gracias por interesarte en la convocatoria Por Amor a México! Por favor completa tu pre-registro respondiendo las siguientes preguntas.</p>
          </div>
        </div>
                <form id="register-form" method="post" onSubmit={this.onSubmit}>
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label>Número de personas que lo integran:</label>
                            <select
                            className="form-control"
                            name="numero_participantes"
                            onChange={this.getParticipantes}> 
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
                            </select>
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                               <input
                               type="text"
                               className="border-input textarea"
                    ...
                    { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                       <span>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                         ...
                         id={"edad_"+(i+1)}
                         name={"edad_"+(i+1)}
                         className="border-input numeros" 
                         type="text"
                         maxLength="2"
                         placeholder="Edad"/>
                        ...
                        <label className="radio-inline"><input name={"egresado_"+(i+1)}  id={"egresado_"+(i+1)} value="true" onChange={this.handleOptionEgreso}    type="radio"/> Sí</label>
                        <label className="radio-inline"><input  name={"egresado_"+(i+1)}  id={"egresado_"+(i+1)} value="false" onChange={this.handleOptionEgreso}  type="radio" /> No</label><br/>
                        <span style={{ color: "red" }}>{this.state.errors["egresado"]}</span>
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                         ...
                         className="border-input numeros"
                         type="text"
                         placeholder="Semestre que cursa actualmente"
                         maxLength="2"
                         readOnly
                         onChange={this.onChange}
                         />
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                         ...
                         maxLength="4"
                         readOnly
                         placeholder="Año de egreso de la Universidad"/>
                         
                
                        </div>  
                    </div>
                    <div className="row">
                        <div id="mexicano-radio" className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        <label>Nacionalidad mexicana</label>
                        <label className="radio-inline mexicano"><input name={"mexicano_"+(i+1)} id={"mexicano_"+(i+1)} value="true" type="radio"/> Sí</label>
                        <label className="radio-inline mexicano"><input name={"mexicano_"+(i+1)} id={"mexicano_"+(i+1)}  value="false" type="radio" /> No</label>
                        </div>   
                    </div>

                    <div  className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <span style={{ color: "red" }}>{this.state.errors["datos_participantes"]}</span><br/>
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label className="vw-question">3- El participante y/o alguno de los integrantes del equipo es familiar, pariente por afinidad o consanguinidad hasta en segundo grado o cónyuge de algún empleado de:
                          </label><br/>
                          <span style={{ color: "red" }}>{this.state.errors["relacion_empleado"]}</span><br/>
                        </div>   
                    </div>
                    <div className="row vw-etiquetas">
                        ...
                        <span>
                        <label className="label-radio"> {etiqueta} </label>
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                        <label>Volkswagen de México, S.A. de C.V. (VW).
                          </label>
                        ...
                        <label className="radio-inline"><input id={"relacion_empleado_1_"+(i+1)} name={"relacion_empleado_1_"+(i+1)} value="true" type="radio"/> Sí</label>
                        <label className="radio-inline"><input id={"relacion_empleado_1_"+(i+1)} name={"relacion_empleado_1_"+(i+1)} value="false" type="radio" /> No</label>
                        </span>
                        ))}
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                        <label>Volkswagen Servicios de Administración de Personal, S.A. de C.V.
                          </label>
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                        <span>
                        <label className="radio-inline"><input id={"relacion_empleado_2_"+(i+1)} name={"relacion_empleado_2_"+(i+1)} value="true" type="radio"/> Sí</label>
                        <label className="radio-inline"><input id={"relacion_empleado_2_"+(i+1)} name={"relacion_empleado_2_"+(i+1)} value="false" type="radio" /> No</label>
                        </span>
                        ))}
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                        <label>Volkswagen Leasing, S.A. de C.V.
                          </label>
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                        <span>
                        <label className="radio-inline"><input id={"relacion_empleado_3_"+(i+1)} name={"relacion_empleado_3_"+(i+1)} value="true" type="radio"/> Sí</label>
                        <label className="radio-inline"><input id={"relacion_empleado_3_"+(i+1)} name={"relacion_empleado_3_"+(i+1)} value="false" type="radio" /> No</label>
                        </span>
                        ))}
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                        <label>Instituto para Formación y Desarrollo Volkswagen, S.C.
                          </label>
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                         <span>
                         <label className="radio-inline"><input id={"relacion_empleado_4_"+(i+1)} name={"relacion_empleado_4_"+(i+1)} value="true" type="radio"/> Sí</label>
                         <label className="radio-inline"><input id={"relacion_empleado_4_"+(i+1)} name={"relacion_empleado_4_"+(i+1)} value="false" type="radio" /> No</label>
                         </span>
                        ))}
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                        <label>Volkswagen Servicios, S.A. de C.V.
                          </label>
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                         <span>
                         <label className="radio-inline"><input id={"relacion_empleado_5_"+(i+1)} name={"relacion_empleado_5_"+(i+1)} value="true" type="radio"/> Sí</label>
                         <label className="radio-inline"><input id={"relacion_empleado_5_"+(i+1)} name={"relacion_empleado_5_"+(i+1)} value="false" type="radio" /> No</label>
                         </span>
                        ))}
                    ...
                    <div className="row">
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                         <span>
                         <label className="radio-inline"><input id={"relacion_empleado_6_"+(i+1)} name={"relacion_empleado_6_"+(i+1)} value="true" type="radio"/> Sí</label>
                         <label className="radio-inline"><input id={"relacion_empleado_6_"+(i+1)} name={"relacion_empleado_6_"+(i+1)} value="false" type="radio" /> No</label>
                         </span>
                        ))}
                        </div>  
                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label className="vw-question">4- El participante y/o alguno de los integrantes del equipo es familiar, pariente por afinidad o consanguinidad hasta en segundo grado o cónyuge de algún empleado o asociado de proveedores, empresas afiliadas y/o subcontratadas que proporcionen servicios, insumos y productos a:
                          </label><br/>
                          <span style={{ color: "red" }}>{this.state.errors["relacion_partner"]}</span><br/>
                    ...
                    <div className="row vw-etiquetas">
                        ...
                        { this.state.labels.map((etiqueta) =>
                        <span>
                        <label className="label-radio"> <stron>{etiqueta} </stron></label>
                    ...
                    <div className="row">
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                        <span>
                        <label className="radio-inline"><input id={"relacion_partner_1_"+(i+1)} name={"relacion_partner_1_"+(i+1)} value="true" type="radio"/> Sí</label>
                        <label className="radio-inline"><input id={"relacion_partner_1_"+(i+1)} name={"relacion_partner_1_"+(i+1)} value="false" type="radio" /> No</label>
                        </span>
                        ))}
                    ...
                    <div className="row">
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                        <span>
                        <label className="radio-inline"><input id={"relacion_partner_2_"+(i+1)} name={"relacion_partner_2_"+(i+1)} value="true" type="radio"/> Sí</label>
                        <label className="radio-inline"><input id={"relacion_partner_2_"+(i+1)} name={"relacion_partner_2_"+(i+1)} value="false" type="radio" /> No</label>
                        </span>
                        ))}
                    ...
                    <div className="row">
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                       <span>
                       <label className="radio-inline"><input id={"relacion_partner_3_"+(i+1)} name={"relacion_partner_3_"+(i+1)} value="true" type="radio"/> Sí</label>
                       <label className="radio-inline"><input id={"relacion_partner_3_"+(i+1)} name={"relacion_partner_3_"+(i+1)} value="false" type="radio" /> No</label>
                       </span>
                        ))}
                    ...
                    <div className="row">
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                         <span>
                         <label className="radio-inline"><input id={"relacion_partner_4_"+(i+1)} name={"relacion_partner_4_"+(i+1)} value="true" type="radio"/> Sí</label>
                         <label className="radio-inline"><input id={"relacion_partner_4_"+(i+1)} name={"relacion_partner_4_"+(i+1)} value="false" type="radio" /> No</label>
                         </span>
                        ))}
                    ...
                    <div className="row">
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                         <span>
                         <label className="radio-inline"><input id={"relacion_partner_5_"+(i+1)} name={"relacion_partner_5_"+(i+1)} value="true" type="radio"/> Sí</label>
                         <label className="radio-inline"><input id={"relacion_partner_5_"+(i+1)} name={"relacion_partner_5_"+(i+1)} value="false" type="radio" /> No</label>
                         </span>
                        ))}
                    ...
                    <div className="row">
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                         <span>
                         <label className="radio-inline"><input id={"relacion_partner_6_"+(i+1)} name={"relacion_partner_6_"+(i+1)} value="true" type="radio"/> Sí</label>
                         <label className="radio-inline"><input id={"relacion_partner_6_"+(i+1)} name={"relacion_partner_6_"+(i+1)} value="false" type="radio" /> No</label>
                         </span>
                        ))}
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label className="vw-question">5- ¿El participante y/o alguno de los integrantes del equipo es funcionario público en activo o persona que ocupa algún cargo público o un cargo activo en algún partido político?
                          </label><br/>
                        
                          <span style={{ color: "red" }}>{this.state.errors["cargo_publico"]}</span><br/>
                    ...
                    <div className="row">
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                         <span>
                         <label className="radio-inline"><input id={"funcionario_publico_"+(i+1)} name={"funcionario_publico_"+(i+1)} value="true" type="radio"/> Sí</label>
                         <label className="radio-inline"><input id={"funcionario_publico_"+(i+1)} name={"funcionario_publico_"+(i+1)} value="false" type="radio" /> No</label>
                         </span>
                        ))}
                    ...
                    <div className="row">
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                        <span>
                        <label className="radio-inline"><input id={"cargo_publico_"+(i+1)} name={"cargo_publico_"+(i+1)} value="true" type="radio"/> Sí</label>
                        <label className="radio-inline"><input id={"cargo_publico_"+(i+1)} name={"cargo_publico_"+(i+1)} value="false" type="radio" /> No</label>
                        </span>
                        ))}
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                        <label>Tiene un cargo en algún partido político.
                          </label>
                        ...
                        { Array.apply(null, { length: this.state.numero_participantes }).map((e, i) => ( 
                       <span>
                       <label className="radio-inline"><input id={"partido_politico_"+(i+1)} name={"partido_politico_"+(i+1)} value="true" type="radio"/> Sí</label>
                       <label className="radio-inline"><input id={"partido_politico_"+(i+1)} name={"partido_politico_"+(i+1)} value="false" type="radio" /> No</label>
                       </span>
                        ))}
                    ...
                    <div className="row">
                        ...
                        <textarea  className="form-control textarea" id="biodiversidad_details" name="biodiversidad_details"  onChange={this.onChange}  maxLength="255" value={this.state.biodiversidad_details} rows="5"></textarea>
                        <br/>
                    ...
                    <div className="row">
                        ...
                        <textarea className="form-control textarea" id="sitio" name="sitio" rows="5" value={this.state.sitio}  maxLength="255" onChange={this.onChange} ></textarea>
                        <br/>
                    ...
                    <div className="row">
                        ...
                        <textarea className="form-control textarea"  onChange={this.onChange} id="aspecto_relevante" name="aspecto_relevante"  maxLength="255" value={this.state.aspecto_relevante} rows="5"></textarea>
                        <br/>
                    ...
                    <div className="row">
                        ...
                        <label><input id="transferencia_datos" name="transferencia_datos" onChange={this.handleOptionChange} type="checkbox" value="true"/>Acepto que mis datos personales aquí proporcionados sean transferidos al Concesionario marca Volkswagen que he elegido, a efecto de que le den seguimiento a mi solicitud*</label>
