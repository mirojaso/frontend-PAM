...
export default class FormRegisterTeam extends Component {
    ...
    onChange = e => {
        ...
        if ((e.target.name === "nombre")||(e.target.name === "nombre_proyecto") ||(e.target.name === "nombre_1")  ) {
    ...
    handleOptionEgreso= e => {
      ...
      if(e.target.value=="true"){
        ...
        $("#semestre_etiqueta_"+myString).hide();
       ...
       $("#semestre_etiqueta_"+myString).show();
      }
                ...
                <div className="row elements-desktop">
                  ...
                  <div className="col-lg-7 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div className="row">
                        ...
                        <textarea  className="form-control" id="biodiversidad_details" name="biodiversidad_details"  onChange={this.onChange}  maxLength="255" value={this.state.biodiversidad_details} rows="5"></textarea>
                        <br/>
                    ...
                    <div className="row">
                        ...
                        <textarea  className="form-control" id="sitio" name="sitio" rows="5" value={this.state.sitio}  maxLength="255" onChange={this.onChange} ></textarea>
                        <br/>
                    ...
                    <div className="row">
                        ...
                        <textarea   className="form-control"  onChange={this.onChange} id="aspecto_relevante" name="aspecto_relevante"  maxLength="255" value={this.state.aspecto_relevante} rows="5"></textarea>
                        <br/>
